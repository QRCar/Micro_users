defmodule Users.AccountTest do
  use Users.DataCase
  ...
  describe "users" do
    ...
    @valid_attrs %{email: "some email", first_name: "first name", last_name: "last name"}
    @update_attrs %{email: "some updated email", first_name: "Amexandre", last_name: "Cailler"}
